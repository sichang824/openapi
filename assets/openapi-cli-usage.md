...
usage: openapi-generator <command> [<args>]

The most commonly used openapi-generator commands are:
...
See 'openapi-generator help <command>' for more information on a specific
command.
```
...
```text
NAME
        openapi-generator version - Show version information used in tooling

SYNOPSIS
        openapi-generator version [--full] [--sha]
...
NAME
        openapi-generator list - Lists the available generators

SYNOPSIS
        openapi-generator list [(-i <include> | --include <include>)]
                [(-s | --short)]
...
NAME
        openapi-generator config-help - Config help for chosen lang

SYNOPSIS
        openapi-generator config-help
...
NAME
        openapi-generator meta - MetaGenerator. Generator for creating a new
...
SYNOPSIS
        openapi-generator meta [(-l <language> | --language <language>)]
                [(-n <name> | --name <name>)]
...
NAME
        openapi-generator validate - Validate specification
...
An example bash completion script can be found in the repo at [scripts/openapi-generator-completion.bash](https://github.com/OpenAPITools/openapi-generator/blob/master/scripts/openapi-generator-completion.bash).
...
NAME
        openapi-generator generate - Generate code with the specified
        generator.
...
NAME
        openapi-generator batch - Generate code in batch via external
        configs.

SYNOPSIS
        openapi-generator batch [--clean] [--fail-fast]
...
NAME
        openapi-generator author - Utilities for authoring generators or
        customizing templates.

SYNOPSIS
        openapi-generator author
        openapi-generator author template [--library <library>]
                [(-v | --verbose)]
                [(-o <output directory> | --output <output directory>)]
                (-g <generator name> | --generator-name <generator name>)
...
```text
openapi-generator help author template
NAME
        openapi-generator author template - Retrieve templates for local
        modification
