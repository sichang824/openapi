...
Upgrade to the latest release when needed:
...
The [npm package wrapper](https://github.com/openapitools/openapi-generator) is cross-platform wrapper around the .jar artifact. It works by providing a CLI wrapper atop the JAR's command line options. This gives a simple interface layer which normalizes usage of the command line across operating systems, removing some differences in how options or switches are passed to the tool (depending on OS).
**Install** the latest version of the tool globally, exposing the CLI on the command line:

```bash
npm install @openapitools/openapi-generator -g
```

To install a specific version of the tool, pass the version during installation:
<!-- RELEASE_VERSION -->
```bash
openapi-generator version-manager set 7.19.0
```
<!-- /RELEASE_VERSION -->
To install the tool as a dev dependency in your current project:

```bash
npm install @openapitools/openapi-generator -D
```
...
```bash
npx @openapitools/openapi-generator generate -i petstore.yaml -g ruby -o /tmp/test/
```
...
```bash
openapi-generator generate -i petstore.yaml -g ruby
```
...
```bash
pip install openapi-generator[jdk4py]
```
...
```bash
docker run --rm \
  -v ${PWD}:/local openapitools/openapi-generator generate \
...
JAR location: `https://repo1.maven.org/maven2/org/openapitools/openapi-generator/7.19.0/openapi-generator-7.19.0.jar`

For **Mac/Linux** users:

```bash
wget https://repo1.maven.org/maven2/org/openapitools/openapi-generator/7.19.0/openapi-generator-7.19.0.jar -O openapi-generator.jar
```

For **Windows** users, you will need to install [wget](http://gnuwin32.sourceforge.net/packages/wget.htm) or you can use Invoke-WebRequest in PowerShell (3.0+), e.g.

```powershell
Invoke-WebRequest -OutFile openapi-generator.jar https://repo1.maven.org/maven2/org/openapitools/openapi-generator/7.19.0/openapi-generator-7.19.0.jar
```
<!-- /RELEASE_VERSION -->

After downloading the JAR, run `java -jar openapi-generator.jar help` to show the usage.
...
One downside to manual JAR downloads is that you don't keep up-to-date with the latest released version. We have a Bash launcher script at [bin/utils/openapi-generator.sh](https://raw.githubusercontent.com/OpenAPITools/openapi-generator/master/bin/utils/openapi-generator.sh) which solves this problem.
...
curl https://raw.githubusercontent.com/OpenAPITools/openapi-generator/master/bin/utils/openapi-generator.sh > ~/bin/openapitools/openapi-generator
chmod u+x ~/bin/openapitools/openapi-generator
export PATH=$PATH:~/bin/openapitools/
```

Now, `openapi-generator` is "installed". On invocation, it will query the GitHub repository for the most recently released version. If this matches the last downloaded jar,
...
```bash
# Execute latest released openapi-generator
openapi-generator version

# Execute version 3.1.0 for the current invocation, regardless of the latest released version
OPENAPI_GENERATOR_VERSION=3.1.0 openapi-generator version

# Execute version 3.1.0-SNAPSHOT for the current invocation
OPENAPI_GENERATOR_VERSION=3.1.0-SNAPSHOT openapi-generator version

# Execute version 3.0.2 for every invocation in the current shell session
export OPENAPI_GENERATOR_VERSION=3.0.2
openapi-generator version # is 3.0.2
openapi-generator version # is also 3.0.2

# To "install" a specific version, set the variable in .bashrc/.bash_profile
echo "export OPENAPI_GENERATOR_VERSION=3.0.2" >> ~/.bashrc
source ~/.bashrc
openapi-generator version # is always 3.0.2, unless any of the above overrides are done ad hoc
```
